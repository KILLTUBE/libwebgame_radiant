...
int WINAPI QERApp_RequestInterface( REFGUID refGUID, LPVOID pInterface )
{
	if (IsEqualGUID( refGUID, QERQglTable_GUID ))
	{
		...
		//pQglTable->m_pfn_glCullFace = glCullFace;
		//pQglTable->m_pfn_glDisable = glDisable;
		//pQglTable->m_pfn_glDeleteLists = glDeleteLists;
		//pQglTable->m_pfn_glEnable = glEnable;
		//pQglTable->m_pfn_glEnd = glEnd;
		//pQglTable->m_pfn_glEndList = glEndList;
		//pQglTable->m_pfn_glGenLists = glGenLists;
		//pQglTable->m_pfn_glListBase = glListBase;
		//pQglTable->m_pfn_glLoadIdentity = glLoadIdentity;
		//pQglTable->m_pfn_glMatrixMode = glMatrixMode;
		//pQglTable->m_pfn_glNewList = glNewList;
		//pQglTable->m_pfn_qglNormal3f = qglNormal3f;
		//pQglTable->m_pfn_glOrtho = glOrtho;
		//pQglTable->m_pfn_glPointSize = glPointSize;
		//pQglTable->m_pfn_glPolygonMode = glPolygonMode;
		//pQglTable->m_pfn_glPopMatrix = glPopMatrix;
		//pQglTable->m_pfn_glPushMatrix = glPushMatrix;
		//pQglTable->m_pfn_qglRotated = qglRotated;
		//pQglTable->m_pfn_glRotatef = glRotatef;
		//pQglTable->m_pfn_qglScalef = qglScalef;
		//pQglTable->m_pfn_glTexCoord2f = glTexCoord2f;
		//pQglTable->m_pfn_glTexEnvf = glTexEnvf;
		//pQglTable->m_pfn_qglTexGenf = qglTexGenf;
		//pQglTable->m_pfn_glTexParameterf = glTexParameterf;
		//pQglTable->m_pfn_qglTranslated = qglTranslated;
		//pQglTable->m_pfn_glTranslatef = glTranslatef;
		//pQglTable->m_pfn_glVertex2f = glVertex2f;
		//pQglTable->m_pfn_glVertex3f = glVertex3f;
		//pQglTable->m_pfn_glViewport = glViewport;
