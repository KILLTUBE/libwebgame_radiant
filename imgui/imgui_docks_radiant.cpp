...
//#include "imgui_dock_z.h"
//#include "imgui_dock_cam.h"

#include <list>
std::list<Dock *> imgui_docks_radiant;

void alignTabsDefault();

CCALL int add_dock(Dock *dock) {
	imgui_docks_radiant.push_back(dock);
	return 1;
}
...
//	int x = screenpos.x;
//	int y = screenpos.y;
//	for (Dock *dock : imgui_docks_radiant) {
